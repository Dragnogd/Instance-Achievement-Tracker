...
local baseLocale = {
	...
	["Ulduar_XTDeconstructor2"] = "要完成这个成就，拉住BOSS然后把他打到到75%%、50%%或25%%开始%s阶段。一旦心脏暴露了就把它打掉然后杀了BOSS。",
	...
	["UpperBlackrockSpire_RagewingTheUntamed"] = "要完成这个成就，先将%s打到70%%血量，然后等待第一波%s刷新。接着将BOSS的血量降到30%%，然后等待第二波%s刷新。最后把所有20个%s聚集在一起，在10秒内把他们AOE掉。完成后，就可以杀死BOSS获得这个成就。",
	--["UpperBlackrockSpire_WarlordZaela"] = "要完成这个成就，将%s降到60%%血量，然后等他升天。接下来杀死5个%s，这些%s在平台的两侧刷新。一旦你杀死了5个%s，你就可以杀死BOSS。",
