...
local baseLocale = {
	...
	--["ALittlePatience_Bubbletrapped"] = "进入场景后，在%s在场时与%s对话，协助巨魔防守，即可获得此成就。",
	--["ALittlePatience_Cannonballer"] = "进入场景后，当%s在场时，与%s对话，协助矮人防守，即可获得此成就。",
	["ALittlePatience_IUsedToLoveThem"] = "进入场景后，在她在场时与%s对话，并协助暗夜精灵防守，即可获得此成就。",
	--["ALittlePatience_WeveBeenDancin"] = "进入场景后，当%s在场时，与%s对话，协助熊猫人防守，即可获得此成就。",
	["ALittlePatience_WhichCameFirst"] = "进入场景后，在她在场时与%s对话，并协助地精防守，即可获得此成就。",
	...
	--["AzsharasEternalPalace_Orgozoa"] = "为了实现这一成就，你必须在阶段转换时指定一个人站在BOSS房间外面的平台边缘抓婴儿%s。然后，抓蛋的人将必须把蛋放到BOSS区，同时在阶段转换期间避免%s和%s。 携带蛋的人不得使用任何技能，否则蛋会掉落。\n\n请确保不要提早打断%s，因为携带鸡蛋的人会很慢，它们会减慢30%（%s ）。 如果组中有牧师，则可以分配该玩家以帮助%s和%s。",
	...
	--["BlackrockCaverns_Corla"] = "要完成这个成就拉住boss然后等待三个%s的人进化。这是通过光束让%s达到100层%s。一旦所有的3个%都进化成%s杀了他们然后杀了boss。",
	...
	--["CryptOfForgottenKings_FightAngerWithAnger"] = "在场景的第四阶段，收集20个位于房间周围的%的暴民。一旦你收集到了20个%s，就将他们A掉，得到20层%s。接下来，在30秒内击杀boss即可获得此成就。",
	...
	--["HeartOfFear_BladeLordTayak"] = "要完成这个成就，将boss的血量降到20%%。接下来，点击房间中央的一个火炬即可获得%s的buff。在房间的远处有4个未点燃的烟袋。跑到房间远处有%s buff的地方，点击未点燃的火盆。这将移除%s buff并点亮火盆。重复这个步骤点燃剩下的3个火盆。当4个火盆都点亮后，就可以击杀boss了。\n\n注意：如果逆风跑得很吃力，可以先点亮逆风方向的2个火盆，然后将boss dps到10%，改变风向去点亮另一边的火盆。",
	...
	--["ScarletHalls_ArmsmasterHarlan"] = "要完成这个成就，先拉住boss，然后在入口旁边的楼梯顶端等待。接下来，等待至少7个%s产生，确保避开boss的%s技能。一旦至少有7个%s产生，只需站在下一个%s与%s中，然后杀死boss就可以获得成就了。",
	...
	--["Scholomance_Other3"] = "到观景房去，这是遇到%s之前的最后一个房间。在一张桌子上你会发现一个%s。点击小瓶后，你将获得1小时的buff。接下来，在%s的作用下击杀潘达利亚地下城中的以下boss：\n\n-%s(第一个boss在%s中)\n-%s(第三个boss在%s中)\n-%s(第一个boss在%s中)\n-%s(第一个boss在%s中)\n-%s(第三个boss在%s中)",
	...
	--["ShadoPanMonastery_TaranZhu"] = "要完成这个成就，队伍中的每个玩家必须在击杀boss之前获得%s的debuff。当玩家的仇恨条达到100%时，就会获得%s。要获得仇恨，只需站在所有boss的技能中即可。一旦队伍中的每个人都获得了%s的debuff，你就可以杀死boss了。",
	...
	--["StormstoutBrewery_Other2"] = "进入副本后与右边的%s对话购买5个%s。当饮用茶水时你将能够看到散落在副本中的%s，持续5分钟。通过点击30个%s找到所有的%s来完成这个成就。",
