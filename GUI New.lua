...
function Config:CreateGUI()
    --Frame
    UIConfig = CreateFrame("Frame", "AchievementTracker", UIParent, "IATFRAME")
	...
	--UIConfig.title:SetPoint("CENTER", AchievementTrackerHeaderText, "CENTER", 6, 1);
    --UIConfig.title:SetText("Instance Achievement Tracker v0.3.0a");
    
    --Title Texture
    --UIConfig.titleTexture = 

    --UIConfig:AchievementTrackerHeaderText:SetText("Test")

    --Scroll Frame
    UIConfig.ScrollFrame = CreateFrame("ScrollFrame", nil, UIConfig, "UIPanelScrollFrameTemplate")
    UIConfig.ScrollFrame:SetPoint("TOPLEFT", AchievementTrackerCategoryFrame, "TOPLEFT", 4, -8)
    UIConfig.ScrollFrame:SetWidth(188)
    ...
    --Scroll Frame
     ...
     UIConfig.ScrollFrame2:SetPoint("TOPRIGHT", AchievementTrackerPanelContainer, "TOPRIGHT", 0, -8)
