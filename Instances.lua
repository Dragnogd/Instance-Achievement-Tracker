	...
	[3] = {
		...
		Dungeons = {
			...
			[1862] = { --Waycrest Manor
				...
				boss3 = {
					name = L["Instances_Other"], --MISSINGNAME5
					bossIDs = {},
					achievement = 12489,
					players = {},
	...
	[4] = {
		...
		Dungeons = {
			...
			[1501] = { --Black Rook Hold
				name = 740,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAM10
					bossIDs = {},
					achievement = 10709,
					players = {},
	...
	[6] = {
		...
		Dungeons = {
			...
			[1007] = { --Scholomance
				...
				boss3 = {
					name = L["Instances_Other"], --MISSINGNAME19
					bossIDs = {59368},
					achievement = 6396,
					players = {},
		...
		Scenarios = {
			...
			[1104] = { --A Little Patience
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME26
					bossIDs = {},
					achievement = 7990,
					players = {},
			...
			[1130] = { --Blood in the Snow
				name = 646,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME32
					bossIDs = {},
					achievement = 8329,
					players = {},
			...
			[1051] = { --Brewmoon Festival
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME34
					bossIDs = {},
					achievement = 6930,
					players = {},
			...
			[1144] = { --Dark Heart of Pandaria
				name = 647,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME36
					bossIDs = {},
					achievement = 8319,
					players = {},
			...
			[1103] = { --Lion's Landing (Alliance)
				name = 590,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME37
					bossIDs = {},
					achievement = 8011,
					players = {},
			...
			[1102] = { --Domination Point (Horde)
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME40
					bossIDs = {},
					achievement = 8015,
					players = {},
			...
			[1024] = { --Greenstone Village
				name = 492,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME41
					bossIDs = {},
					achievement = 7267,
					players = {},
			...
			[1131] = { --Secrets of Ragefire
				name = 649,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME43
					bossIDs = {},
					achievement = 8295,
					players = {},
			...
			[1048] = { --Unga Ingoo
				name = 499,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME44
					bossIDs = {},
					achievement = 7231,
					players = {},
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME45
					bossIDs = {},
					achievement = 7232,
					players = {},
	...
	[7] = {
		...
		Dungeons = {
			...
			[644] = { --Halls of Origination
				...
				boss3 = {
					name = L["Instances_Other"], --MISSINGNAME48
					bossIDs = {},
					achievement = 5296,
					players = {},
					tactics = L["Shared_JustKillBoss"],
	...
	[8] = {
		Raids = {
			...
			[603] = { --Ulduar
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME53
					bossIDs = {},
					achievement = 12313,
					players = {},
			...
			["533-10"] = { --Naxxramas 10 Man
				name = 754,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME54
					bossIDs = {},
					achievement = 578,
					players = {},
					tactics = L["Shared_JustKillBoss"],
			...
			["533-25"] = { --Naxxramas 25 Man
				name = 754,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME55
					bossIDs = {},
					achievement = 579,
					players = {},
					tactics = L["Shared_JustKillBoss"],
		...
		Dungeons = {
			...
			[595] = { --The Culling of Stratholme
				name = 279,
				boss1 = {
					name = L["Instances_Other"], --MISSINGNAME56
					bossIDs = {27737},
					achievement = 1872,
					players = {},
			...
			[608] = { --Violet Hold
				...
				boss2 = {
					name = L["Instances_Other"], --MISSINGNAME58
					bossIDs = {},
					achievement = 1865,
					players = {},
