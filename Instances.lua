		...
		Raids = {
			[2296] = { --Castle Nathria
				...
				boss9 = {
					...
					achievement = 14525,
					players = {},
					tactics = format(L["CastleNathria_StoneLegionGenerals"], GetSpellLink(339565), GetSpellLink(333387), GetSpellLink(334929), GetSpellLink(339574), GetSpellLink(339565), GetSpellLink(333387), "IAT_156987", GetSpellLink(334929), GetSpellLink(334929), GetSpellLink(189110), GetSpellLink(343881), GetSpellLink(334929), GetSpellLink(343881), GetSpellLink(339574)),
					enabled = true,
		...
		Raids = {
			...
			[603] = { --Ulduar
				...
				boss11 = {
					...
					achievement = 12322,
					players = {},
					tactics = format(L["Ulduar_Razorscale"], "IAT_33186", "IAT_109674", "IAT_33186", "IAT_33186", "IAT_109674", GetSpellLink(64021)),
					enabled = true,
