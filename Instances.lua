        ...
        Raids = {
            ...
            [1712] = { --Antorus the Burning Throne
                ...
                boss3 = {
                    ...
                    achievement = 12129,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = "At max level, you can just nuke the boss down without placing any felshield emitters",
                    enabled = true,
