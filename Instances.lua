        ...
        Dungeons = {
            ...
            [1754] = { --Freehold
                ...
                boss1 = {
                    ...
                    achievement = 12548,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = format("To summon Patches you have to place a %s before you pull the boss.\n\nYou can purchase the %s from Benjamin Brode in the Garrison for 1,000.", GetSpellLink(119210), GetSpellLink(119210)),
                    enabled = true,
