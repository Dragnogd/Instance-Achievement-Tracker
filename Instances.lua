        ...
        Raids = {
            [1861] = { --Uldir
                ...
                boss2 = {
                    ...
                    achievement = 12938,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = "To enter the 'passcode' you will have to click the buttons in each chamber in a specific order that is randomized for every group. The order can be 321, 213, 231 or other combinations.\n\n Just send a group of 2-3 dps and a healer to click on the buttons in the second and the third room, and once the buttons are clicked in the right sequence, they will stop blinking and won't be clickable anymore. Once you've done that you can kill the boss and get the achievement.",
                    enabled = false,
                    track = nil,
                    partial = false,
                    encounterID = 2141,
                ...
                boss8 = {
                    ...
                    achievement = 12551,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = "For this achievement you will have make groups of 3 people (1 healer + 2 dps) to do the power matrix and rotate them throughout the fight.\n\n As of right now the fight looks a bit overtuned for smaller raid groups, so if have a 10-14 man group then you should invite a few more people to help out.",
                    enabled = false,
                    track = nil,
                    partial = false,
                    encounterID = 2122,
