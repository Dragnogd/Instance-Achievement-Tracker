--------------------------------------
-- Last Auto Generated: 02/04/2026 20:26:08 using https://github.com/Dragnogd/Instance-Achievement-Tracker-Database-Manager
--------------------------------------
local _, core = ...
local L = core.L
local instances = {}
		...
		Raids = {
			[2939] = { --The Dreanrift
				...
				boss1 = {
					...
					enabled = true,
					track = function() core._2939:Chimaerus() end,
					partial = false,
					encounterID = 3306,
				},
			},
			...
			[2912] = { --The Voidspire
				...
				boss1 = {
					...
					enabled = true,
					track = function() core._2912:ImperatorAverzian() end,
					partial = false,
					encounterID = 3176,
				},
				boss2 = {
					...
					enabled = true,
					track = function() core._2912:Vorasius() end,
					partial = false,
					encounterID = 3177,
				},
				boss3 = {
					...
					enabled = true,
					track = function() core._2912:FallenKingSalhadaar() end,
					partial = false,
					encounterID = 3179,
				},
				boss4 = {
					...
					enabled = true,
					track = function() core._2912:VaelgorEzzorak() end,
					partial = false,
					encounterID = 3178,
				},
				boss5 = {
					...
					enabled = true,
					track = function() core._2912:LightblindedVanguard() end,
					partial = false,
					encounterID = 3180,
				},
				boss6 = {
					...
					enabled = true,
					track = function() core._2912:CrownOfTheCosmos() end,
					partial = false,
					encounterID = 3181,
				},
			},
			...
			[2913] = { --March on Quel'Danas
				...
				boss1 = {
					...
					enabled = true,
					track = function() core._2913:BelorenChildOfAlar() end,
					partial = false,
					encounterID = 3182,
				},
				boss2 = {
					name = 2740, --Midnight Falls
					bossIDs = {},
					achievement = 62406,
					players = {},
					tactics = {
						[12] = {
							{ tactic = L["MarchonQuelDanas_MidnightFalls_1"] },
						},
					},
					enabled = true,
					track = function() core._2913:MidnightFalls() end,
					partial = false,
					encounterID = 3183,
				},
			},
