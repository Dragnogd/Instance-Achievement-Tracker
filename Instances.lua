        ...
        Raids = {
            ...
            [1530] = { --The Nighthold
                ...
                boss10 = {
                    ...
                    achievement = 10696,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = "During phase 2, spread out around the room and wait for the eyes to spawn. Once 16 Eyes of Gul'dan have spawned, nuke them down within 3 seconds of one another.",
                    enabled = true,
            ...
            [1676] = { --Tomb of Sargeras
                ...
                boss3 = {
                    ...
                    achievement = 11699,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = format("To spawn Elder Murk-Eye someone in the raid has to use the IAT_143660 toy which is obtained by completing the %s achievement.\n\n Use the toy at the start of the fight, focus Elder Murk-Eye, and after he dies you can kill the boss.", GetAchievementLink(11427)),
                    enabled = true,
