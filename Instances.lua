        ...
        Raids = {
            ...
            [2070] = { --Battle of Dazar'alor
                ...
                boss9 = {
                    ...
                    achievement = 13410,
                    players = {},
                    tactics = format(L["BattleOfDazaralor_JainaProudmoore"], "IAT_149684", "IAT_149244"),
                    enabled = true,
        ...
        Raids = {
            ...
            [1648] = { --Trial of Valor
                ...
                boss2 = {
                    ...
                    achievement = 11386,
                    players = {},
                    tactics = format(L["TrialOfValor_Guarm"], GetSpellLink(231846), GetSpellLink(227539), GetSpellLink(227566), GetSpellLink(227566), GetSpellLink(227883)),
                    enabled = true,
                    track = function() end,
                    partial = false,
                    encounterID = 1962,
