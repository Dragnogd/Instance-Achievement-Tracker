        ...
        Dungeons = {
            [1763] = { --Atal Dazar
                ...
                boss3 = {
                    ...
                    achievement = 12273,
                    players = {L["(Enter instance to start scanning)"]},
                    tactics = format("In order to lit the Shadowflame Sconces, everyone in the group except the tank will have to spread and stay near one of them when the boss casts %s. The sconces will stay lit up for about 25 seconds, so you should do this when the boss is low on health around 5 to 10%%.", GetSpellLink(259190)),
                    enabled = false,
                    track = nil,
                    partial = false,
                    encounterID = 2087,
