...
local baseLocale = {
	...
	-- ["BattleOfDazaralor_JainaProudmoore"] = "Para completar este logro harán falta 3 jugadores para recoger montones de nieve durante el combate contra %s.\n\n Los montones de nieve sólo se pueden encontrar en la primera interfase. Los montones de nieve se distribuirán alrededor del área circular de combate así que harán falta al menos 3 personas de movimiento rápido para correr tan pronto empiece la interfase.\n\n Habrá que caminar por encima de los montones de nieve lo que hará aparecer  un pequeño copo de nieve junto a los personajes. Una vez recogidos los 3, habrá que interrumpir al boss para pasar a fase 2. Los jugadores con los copos de nieve tendrán que juntarse cerca de uno de los barriles para crear el %s. Tras ello el jugador que reciba %s tendrá que ir a ese barril para derretir al %s. Tras ello ya se podrá matar el boss y recibir el logro.",
