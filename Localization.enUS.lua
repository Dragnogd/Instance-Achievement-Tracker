...
local baseLocale = {
    ...
    -------------------------------------------------------
    --Tactics
    ["BattleOfDazaralor_ChampionOfTheLight"] = "For this achievement you will need to steal 3 shinies from each of the enemies of the encounter. There is one %s/%s, two %s/%s and %s/%s, so you will have to steal a total of 6 shinies from %s/%s, 3 from %s/%s and 3 from the %s/%s.\n\n Before starting the encounter, you will find a clickable Mysterious Trashpile which will grant you the %s debuff. Every member in your raid should click it to get the debuff. \n\n Every now and then, players will get transformed into a %s and get an extra action button to use on the enemies to steal one shiny coin from them. Once you have stolen a coin you have to bring it back to the Mysterious Trashpile.\n\n Once you've handed in the 12 shiny coins you can kill the boss and get the achievement.",
    ["BattleOfDazaralor_JadefireMasters"] = "For this achievement you will first have to pick up the hidden %s in the boss arena. The egg won't be visible until you’re on top of it. Pick it up after pulling the boss, and keep it away from any harmful abilities, such as the %s in Phase 1 and the %s in Phase 2.\n\n The monk will transform into a %s in Phase 3. Make sure that its %s hits the player holding the egg, and then kill the boss to get the achievement.\n\n The locations of the %s are different for Horde and Alliance.",
